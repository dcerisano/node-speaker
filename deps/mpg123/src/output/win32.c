...
#define NUM_BUFFERS 8  /* total 32k roughly 0.18 sec of CD quality stereo sound */
...
static int open_win32(struct audio_output_struct *ao)
{
	...
	case MPG123_ENC_UNSIGNED_24:
		out_fmt.wFormatTag = WAVE_FORMAT_PCM;
		out_fmt.wBitsPerSample = 24;
		break;
	case MPG123_ENC_SIGNED_32:
	case MPG123_ENC_UNSIGNED_32:
		out_fmt.wFormatTag = WAVE_FORMAT_PCM;
		out_fmt.wBitsPerSample = 32;
		break;
	case MPG123_ENC_FLOAT_32:
		out_fmt.wFormatTag = WAVE_FORMAT_IEEE_FLOAT;
		out_fmt.wBitsPerSample = 32;
		break;
	}
...
static int get_formats_win32(struct audio_output_struct *ao)
{
	 ...
	 *  By: Mathijs van Velde [GitHub](https://github.com/MathijsvVelde)
	 */
	return MPG123_ENC_UNSIGNED_8 | MPG123_ENC_SIGNED_8 | MPG123_ENC_SIGNED_16 | MPG123_ENC_UNSIGNED_16 | MPG123_ENC_SIGNED_24 | MPG123_ENC_UNSIGNED_24 | MPG123_ENC_SIGNED_32 | MPG123_ENC_UNSIGNED_32 | MPG123_ENC_FLOAT_32;
}
